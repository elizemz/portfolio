    ...
    <div className="group px-16">
      <div className="text-black dark:text-white">
        <div className="flex flex-row">
          ...
          <div className="ml-[228px] opacity-0 group-hover:opacity-25 mt-2.5">
            -
          </div>
          <div className="opacity-0 text-xs group-hover:text-xl group-hover:opacity-100 ml-12 text-indigo-950 dark:text-blue-100">
            <div className="font-medium uppercase">GAME UI PRACTICE</div>
            <div className="opacity-60">UI/UX · Interactive · Redesign</div>
            <div className="opacity-40 max-w-96">
              made an overhaul of a mobile game UI
            </div>
          </div>
          <Modal />
        </div>
